...
//OV2640 相关IO 
#define  OV2640_VSYNC 	(GPIOA->IDR&0x00000004)>>2				//帧信号   						PA2
#define  OV2640_PWDN(n) HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, n)	//POWER DOWN控制信号  PA3
#define  OV2640_RST(n)  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, n)	//复位控制信号 				PA4
#define  OV2640_HREF  	(GPIOA->IDR&0x00000100)>>8			  //HREF信号 						PA8
#define  OV2640_PCLK  	(GPIOA->IDR&0x00000800)>>11				//PCLK信号 						PA11
#define  OV2640_DATA   	(GPIOC->IDR&0x07F8)>>3	//数据输入端口 32位寄存器，0~15位对应gpio0~15,后16位保留，3~10脚接8位并口
